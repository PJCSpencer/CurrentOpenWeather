...
protocol PJCURLRequestHeadersProvider
{
...
extension PJCURLRequestHeaders: PJCURLRequestHeadersProvider
{
    func allHTTPHeaderFields() -> [String:String]
    {
...
extension PJCURLRequestAccept: PJCURLRequestHeadersProvider
{
    func allHTTPHeaderFields() -> [String:String]
...
extension PJCURLRequestAuthorization: PJCURLRequestHeadersProvider
{
    func allHTTPHeaderFields() -> [String:String]
    {
...
extension PJCURLRequestContent: PJCURLRequestHeadersProvider
{
    func allHTTPHeaderFields() -> [String:String]
    {
        ...
        if let encoding = self.encoding { print(encoding) /* TODO: */ }
        if let length = self.length { print(length) /* TODO: */ }
